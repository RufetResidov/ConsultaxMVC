...
namespace ConsultaxMVC.Areas.Admin.Controllers
{
    ...
    public class TestimonialsController : Controller
    {
        ...
        public TestimonialsController(ConsultaxTable context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,FromCity,Title,PhotoUrl")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,FromCity,Title,PhotoUrl")] Testimonial testimonial)
        {
